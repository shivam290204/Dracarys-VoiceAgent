...
import { Bot, BrushCleaning, Maximize2, Minus, Plus, Settings } from 'lucide-react';
...
function RenderWorkflow({
    ...
    const [isSimpleMode, setIsSimpleMode] = useState(!isUserAdmin);
                ...
                <div className="flex-1 min-h-0">
                    {isSimpleMode ? (
                        <SimpleWorkflowView 
                            ...
                            onGoToAdvanced={() => setIsSimpleMode(false)}
                        />
                    ) : (
                    <>
