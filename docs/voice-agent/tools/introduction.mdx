...
Tools let your AI agent take actions during a conversation — transfer calls, hand the caller to another agent, end calls, call external APIs, or invoke remote MCP servers — based on the context of the conversation and your prompt instructions.
...
- [**Transfer to Agent**](/voice-agent/tools/transfer-agent) — Hand the live call to another Dograh agent, carrying a handover note with it
